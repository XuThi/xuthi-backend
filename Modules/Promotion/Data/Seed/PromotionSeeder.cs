    ...
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        if (!await promoDb.Vouchers.AnyAsync())
        {
            ...
            promoDb.Vouchers.AddRange(
                ...
                new Voucher
                {
                    Id = Guid.NewGuid(),
                    Code = "BLACKFRIDAY",
                    Description = "Giảm 15% mua sắm Black Friday",
                    Type = VoucherType.Percentage,
                    DiscountValue = 15,
        ...
        if (!await promoDb.SaleCampaigns.AnyAsync())
        {
            ...
            var blackFriday = new SaleCampaign
            {
                ...
                Name = "Black Friday",
                Slug = "black-friday",
                Description = "Ưu đãi cực sốc cho mua sắm Black Friday",
                BannerImageUrl = "https://res.cloudinary.com/dxlhncwp0/image/upload/v1774888633/banner_te2602.jpg",
                BannerImagePublicId = "banner_te2602",
            ...
            var double11 = new SaleCampaign
            {
                ...
                Description = "Giảm giá đặc biệt ngày 11.11",
                BannerImageUrl = "https://res.cloudinary.com/dxlhncwp0/image/upload/v1772593930/sale_campaign_qdfw1l.jpg",
                BannerImagePublicId = "sale_campaign_qdfw1l",
                Type = SaleCampaignType.SeasonalSale,
                StartDate = now.AddDays(-1),
